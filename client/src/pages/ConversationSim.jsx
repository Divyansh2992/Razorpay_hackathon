...
export default function ConversationSim() {
  ...
  return (
    <div>
      <div className="infobox infobox-amber" style={{ marginBottom: 16, fontSize: 12 }}>
        🧪 <strong>Sandbox, not a live feature.</strong> The replies here are genuinely generated by Groq's LLM (no scripting) — but this page isn't wired to any real customer, transaction, or invoice. It exists to let you inspect the model's actual reasoning for the "AI Chat" (L4) and "Voice" (L5) escalation levels. In the live pipeline right now, L4/L5 send one templated message rather than holding this kind of back-and-forth — real conversational recovery happens instead via the customer-facing chat on the Store page and the B2B reply/approval flow, both wired to real data.
      </div>
